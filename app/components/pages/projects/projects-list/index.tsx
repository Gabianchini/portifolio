...
export const ProjectsList = () => {
    return(
        ...
        <ProjectCard
         ...
         <Link href="/projects/chat" aria-label="chat" role="button">
         <ProjectCard
         img="/images/chat.png"
         name="Chat"
         description="Chat App is a real-time messaging application that allows users to create accounts, sign in, search for other users, and send/receive messages in real-time. It provides a seamless and interactive chatting experience."
         techs="Tools: React.js, Node.js, Express, MongoDB, Mongoose, Socket.io, Zustand, TailwindCSS, Vite, React-hot-toast, DaisyUI"/>
        </Link>
