...
export const MainProjects = () => {
    return(
        <section className="container py-16">
            ...
            children= {<><TechBadge name={"React.js"}/> <TechBadge name={"Next.js"}/> <TechBadge name={"Radix-ui"}/> <TechBadge name={"Storybook"}/> <TechBadge name={"Contentful"}/> <TechBadge name={"Sass"}/> <TechBadge name={"Zustand"}/> <TechBadge name={"API"}/> </>}
            />
            </div>
