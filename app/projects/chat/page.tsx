...
export default function Chat() {
    return(
        <ProjectDetails projectName="Chat" techs={<><TechBadge name="React.js"/><TechBadge name="Java Script"/><TechBadge name="Node.js"/><TechBadge name="MongoDB"/><TechBadge name="Express"/><TechBadge name="Socket.io"/><TechBadge name="TailwindCSS"/><TechBadge name="DaisyUI"/><TechBadge name="Bcrypt"/><TechBadge name="Zustand"/><TechBadge name="Mongoose"/></>} link="https://github.com/Gabianchini/chat-app" button={<Button className="min-w-[180px]"><FaGithub></FaGithub>Code</Button>}  description="Chat App is a real-time messaging application that allows users to create accounts, sign in, search for other users, and send/receive messages in real-time. It provides a seamless and interactive chatting experience.">
        </ProjectDetails>
    )
}