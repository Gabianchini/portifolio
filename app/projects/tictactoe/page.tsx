...
export default function Tictactoe () {
    return(
        ...
        button={<Button className="min-w-[180px]"><FaLink></FaLink>Online Project</Button>} 
        ...
        <a href="https://github.com/Gabianchini/JogoDaVelha" target="_blank"><Button><FaGithub></FaGithub>Code</Button></a>
        </ProjectDetails>
